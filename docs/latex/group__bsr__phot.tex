...
{\footnotesize\ttfamily subroutine sym\+\_\+mat1 (\begin{DoxyParamCaption}\item[{integer, intent(in)}]{n,  }\item[{integer, intent(in)}]{m,  }\item[{real(8), dimension(m,m)}]{R,  }\item[{real(8), intent(out)}]{dmn,  }\item[{real(8), intent(out)}]{dmx,  }\item[{real(8), intent(out)}]{dav }\end{DoxyParamCaption})}
