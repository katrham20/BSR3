...
!======================================================================
      ...
      Do ij8 = 1,ij_oper
       Do j=1,noper
        if(IT_oper(j,ij8).eq. 0) IT_oper(j,ij8)=1
        if(IT_oper(j,ij8).eq.-1) IT_oper(j,ij8)=0
       End do 
      End do
      write(nu) IT_oper
...
!======================================================================
      ...
      read(nu) ij8
      if(ij_oper.lt.ij8) Stop 'Read_oper_LS: nsymt too small' 
      read(nu) ((IT_oper(i,j),i=1,noper),j=1,ij8)
